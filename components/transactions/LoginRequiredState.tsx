  ...
  return (
    <div className="flex min-h-[400px] flex-col items-center justify-center rounded-2xl border border-dashed border-zinc-200 bg-zinc-50/50 p-8 text-center dark:border-zinc-800 dark:bg-zinc-900/50">
      ...
      <p className="mb-8 max-w-sm text-zinc-500 dark:text-zinc-400">
        You need to sign in with your Google account to view your transaction
        history, check your balance, and track your spending.
      </p>
      <button
        onClick={handleSignIn}
        className="inline-flex items-center justify-center gap-3 rounded-xl bg-blue-600 px-8 py-3.5 text-sm font-semibold text-white transition-all hover:bg-blue-700 active:scale-[0.98]"
      >
